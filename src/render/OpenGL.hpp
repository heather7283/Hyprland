...
class CHyprOpenGLImpl {
  public:
    ...
    void renderBorder(const CBox&, const CGradientValueData&, int round, float roundingPower, int borderSize, float a = 1.0, int outerRound = -1 /* use round */, uint8_t drawnBordersMask = 0xff);
