...
void CHyprOpenGLImpl::renderBorder(const CBox& box, const CGradientValueData& grad, SBorderRenderData data) {
    ...
    m_shaders->m_shBORDER1.setUniformInt(SHADER_DRAW_BORDER_TOP, data.drawnBordersMask & DRAWN_BORDERS_TOP);
    m_shaders->m_shBORDER1.setUniformInt(SHADER_DRAW_BORDER_BOTTOM, data.drawnBordersMask & DRAWN_BORDERS_BOTTOM);
    m_shaders->m_shBORDER1.setUniformInt(SHADER_DRAW_BORDER_LEFT, data.drawnBordersMask & DRAWN_BORDERS_LEFT);
    m_shaders->m_shBORDER1.setUniformInt(SHADER_DRAW_BORDER_RIGHT, data.drawnBordersMask & DRAWN_BORDERS_RIGHT);
